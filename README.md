...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/dedalus-labs/dedalus-sdk-sql/issues/new).
...
```sh
git clone git@github.com:dedalus-labs/dedalus-sdk-sql.git
cd dedalus-sdk-sql
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/dedalus-labs/dedalus-sdk-sql/issues) with questions, bugs, or suggestions.
